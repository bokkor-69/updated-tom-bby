...
config: {
 ...
 onStart: async function ({  }) { },
  ...
  var Messages = ["Hmm bol", "Ki kobi ko somoy nai🥱", " আপনার কি চরিত্রে সমস্যা যে এতো বার আমাকে বট বলে ডাকতেছেন🧐", "🙂বট বট না বলে সিরিয়াস রিলেশন করতে চাইলে bokkor এর ইনবক্স যাও ", "🙂Bot bot koros kn?","bokkor tomake bhalobashe"];
  ...
  if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "good night")) {
     return api.sendMessage("️", threadID, messageID);
   };
  ...
  if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "Tasbiul")) {
     return api.sendMessage("️", threadID, messageID);
   };
