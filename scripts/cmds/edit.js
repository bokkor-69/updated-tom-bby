...
module.exports.config = {
    ...
    key: "dipto008", // 🔑 এখানে key যুক্ত করা হলো
    guide: {
...
async function handleEdit(api, event, args, commandName) {
    ...
    try {
        const response = await axios.get(`${dipto}/edit?url=${encodeURIComponent(url)}&prompt=${encodeURIComponent(prompt)}&key=dipto008`, {
            responseType: 'stream',
            validateStatus: () => true
        });
